...
pred_uncertainty = pred_interval(N=164,Y=data$nh,
                                 lambda=lambda,step=1:5,type='pred',lg='global')
conf_uncertainty = pred_interval(N=164,Y=data$nh,
                                 lambda=lambda,step=1:5,type='conf',lg='global')
...
ggsave(file=paste("one_step_", lambda, ".pdf"), plot=plot_one_step, width=8, height=5)
...
ggsave(file=paste("resplot", lambda, ".pdf"), plot=plot_pred_err, width=10, height=6)
...
ggsave(file=paste("forecast_", lambda, ".pdf"), plot=plot_forecast, width=8, height=5)
...
ggsave(file=paste("close_",lambda,".pdf", sep = ""), plot=plot_close, width=5, height=4)
