...
ggsave(file=paste("one_step_lambda", lambda, ".pdf"), plot=plot_one_step, width=8, height=5)
...
ggsave(file=paste("forecast_lambda", lambda, ".pdf"), plot=plot_forecast, width=8, height=5)
...
ggsave(file=paste("close_lambda",lambda,".pdf", sep = ""), plot=plot_close, width=5, height=4)
