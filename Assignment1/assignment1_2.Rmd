...
calculate_theta<-function(N, Y, lambda=1){
  ...
  #if N=1 the estimate of theta is just [Y_1, 0]
...
#ggsave(file="resplotglobal.pdf", plot=plot_global_pred_err, width=10, height=6)

#plot of forecasted values
plot_global_forecast <- plot_global_one_step +
...
#ggsave(file="global.pdf", plot=plot_global_forecast, width=8, height=5)

#close up plot of forecasted values
plot_global_close<-plot_data+
...
#ggsave(file="global2.pdf", plot=plot_global_close, width=5, height=4)
plot_global_one_step
plot_global_pred_err
